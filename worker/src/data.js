...
const HISTORY = {
  ...
  '2-2': { year: 1536, event: 'Bern conquers the Vaud region from Savoy', eventDE: 'Bern erobert die Waadt von Savoyen' },
  ...
  '2-10': { year: 1798, event: 'French troops enter Bern, ending the Old Swiss Confederacy', eventDE: 'Französische Truppen marschieren in Bern ein' },
  '2-12': { year: 1528, event: 'Bern officially introduces the Reformation', eventDE: 'Bern führt offiziell die Reformation ein' },
  ...
  '2-17': { year: 2003, event: 'Congestion charge proposed for Swiss cities sparks national debate', eventDE: 'Staugebühr für Schweizer Städte löst nationale Debatte aus' },
  ...
  '2-20': { year: 2002, event: 'Switzerland joins the United Nations as 190th member state', eventDE: 'Die Schweiz tritt als 190. Mitglied den Vereinten Nationen bei' },
  '2-22': { year: 1857, event: 'Robert Baden-Powell, founder of the Scout movement, is born — Swiss Scouting became one of the largest youth movements', eventDE: 'Robert Baden-Powell, Gründer der Pfadfinderbewegung, wird geboren — Schweizer Pfadfinder wurden eine der grössten Jugendbewegungen' },
  '2-24': { year: 1971, event: 'First session of Swiss parliament with female members after suffrage', eventDE: 'Erste Parlamentssitzung mit weiblichen Mitgliedern nach Einführung des Frauenstimmrechts' },
  '2-28': { year: 1499, event: 'Battle of Hard during the Swabian War — Swiss defeat Habsburg forces', eventDE: 'Schlacht bei Hard im Schwabenkrieg — Schweizer besiegen habsburgische Truppen' },
