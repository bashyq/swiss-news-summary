...
function getStayHomeActivities() {
  const s = (id, name, nameDE, desc, descDE, sub, age, dur, mat, matDE) =>
    ({ id: `stayhome-${id}`, name, nameDE, description: desc, descriptionDE: descDE, category: 'stayhome', subcategory: sub, indoor: true, ageRange: `${age[0]}-${age[1]} years`, minAge: age[0], maxAge: age[1], duration: dur, materials: mat, materialsDE: matDE, suggestibility: 'feedOnly' });
