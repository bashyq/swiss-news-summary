...
/// This file is duplicated in both the main app and widget extension targets
/// because both need access to the type (main app for Activity.request,
/// widget extension for ActivityConfiguration).
